...
docker stop postgres_container kafka_container zookeeper_container transaction_service anti_fraud_service api_gateway 2>nul
docker rm postgres_container kafka_container zookeeper_container transaction_service anti_fraud_service api_gateway 2>nul
